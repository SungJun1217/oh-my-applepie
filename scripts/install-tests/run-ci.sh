...
utils_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-pi-utils-*.tgz)"
natives_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-pi-natives-*.tgz)"
ai_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-pi-ai-*.tgz)"
agent_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-pi-agent-core-*.tgz)"
tui_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-pi-tui-*.tgz)"
stats_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-omp-stats-*.tgz)"
coding_agent_tgz="$(find_tarball "$TARBALL_DIR"/oh-my-applepie-pi-coding-agent-*.tgz)"
...
(
	...
	node -e "
		...
		pkg.overrides = {
			'@oh-my-applepie/pi-utils': '$utils_tgz',
			'@oh-my-applepie/pi-natives': '$natives_tgz',
			'@oh-my-applepie/pi-ai': '$ai_tgz',
			'@oh-my-applepie/pi-agent-core': '$agent_tgz',
			'@oh-my-applepie/pi-tui': '$tui_tgz',
			'@oh-my-applepie/omp-stats': '$stats_tgz',
			'@oh-my-applepie/pi-coding-agent': '$coding_agent_tgz'
		};

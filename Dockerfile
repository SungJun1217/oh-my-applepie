...
#
# Build:
#     docker build -t oh-my-applepie/pi:dev .                          # default = pi-runtime
#     docker build --target pi-base -t oh-my-applepie/pi-base:dev .    # base for derived images
#
# Run:
#     docker run --rm oh-my-applepie/pi:dev --help
#     docker run --rm -it -v "$PWD":/work oh-my-applepie/pi:dev cli    # interactive omp
#
# Consume as a base in another Dockerfile (see Dockerfile.robomp):
#     ARG PI_BASE=oh-my-applepie/pi:dev
...
#
# A self-contained, runnable omp image. `docker run oh-my-applepie/pi:dev --help`

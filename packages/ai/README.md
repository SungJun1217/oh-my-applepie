...
```bash
npm install @oh-my-applepie/pi-ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "@oh-my-applepie/pi-ai";
...
```typescript
import { z, Tool } from "@oh-my-applepie/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@oh-my-applepie/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@oh-my-applepie/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@oh-my-applepie/pi-ai";
...
```typescript
import { getModel, stream } from "@oh-my-applepie/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@oh-my-applepie/pi-ai";
...
```typescript
import { Model, stream } from "@oh-my-applepie/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@oh-my-applepie/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@oh-my-applepie/pi-ai";
...
```typescript
import { getEnvApiKey } from "@oh-my-applepie/pi-ai";
...
```bash
bunx @oh-my-applepie/pi-ai login              # interactive provider selection
bunx @oh-my-applepie/pi-ai login anthropic    # login to specific provider
bunx @oh-my-applepie/pi-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @oh-my-applepie/pi-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@oh-my-applepie/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@oh-my-applepie/pi-ai";
import * as fs from "node:fs";

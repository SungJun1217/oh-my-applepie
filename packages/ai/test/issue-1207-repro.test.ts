...
import { detectOpenAICompat, resolveOpenAICompat } from "@oh-my-applepie/pi-ai/providers/openai-completions-compat";
import type { Context, Model, Tool } from "@oh-my-applepie/pi-ai/types";

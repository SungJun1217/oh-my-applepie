...
import { CONFIG_DIR_NAME, getConfigAgentDirName, getProjectDir } from "@oh-my-applepie/pi-utils";
 ...
 * // → [{ path: "~/.omp/agent/commands", source: ".omap", level: "user" }, ...]
 *
 * @example

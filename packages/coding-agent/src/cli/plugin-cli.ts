...
import { APP_NAME, getProjectDir } from "@oh-my-applepie/pi-utils";
...
async function handleInstall(
	...
	if (packages.length === 0) {
		...
		console.error(chalk.dim(`  ${APP_NAME} plugin install @oh-my-applepie/exa`));
...
${chalk.bold("Examples:")}
  ${APP_NAME} plugin install @oh-my-applepie/exa[search]

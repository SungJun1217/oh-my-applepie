...
// fork, or the canonical @oh-my-applepie scope itself) are remapped to this scope and
...
const CANONICAL_PI_SCOPE = "@oh-my-applepie";

// Scopes that have historically been used to publish (or alias) the same set
// of internal pi-* packages. `@oh-my-applepie` is intentionally included so that
...
const PI_SCOPE_ALIASES = ["oh-my-applepie", "oh-my-pi", "mariozechner", "earendil-works"] as const;

...
import type { OAuthCredentials, OAuthLoginCallbacks } from "@oh-my-applepie/pi-ai/utils/oauth/types";
import type * as piCodingAgent from "@oh-my-applepie/pi-coding-agent";
import type { AutocompleteItem, Component, EditorTheme, KeyId, TUI } from "@oh-my-applepie/pi-tui";
...
export interface ExtensionAPI {
	...
	logger: typeof import("@oh-my-applepie/pi-utils").logger;

...
import type { ThinkingLevel } from "@oh-my-applepie/pi-agent-core";
import type { ImageContent, Model, TextContent } from "@oh-my-applepie/pi-ai";
import type { KeyId } from "@oh-my-applepie/pi-tui";
import { hasFsCode, isEacces, isEnoent, logger } from "@oh-my-applepie/pi-utils";
...
class ConcreteExtensionAPI implements ExtensionAPI, IExtensionRuntime {
	...
	constructor(
		public readonly pi: typeof import("@oh-my-applepie/pi-coding-agent"),
	...
	registerTool<
		TParams extends import("@oh-my-applepie/pi-ai").TSchema = import("@oh-my-applepie/pi-ai").TSchema,
		TDetails = unknown,

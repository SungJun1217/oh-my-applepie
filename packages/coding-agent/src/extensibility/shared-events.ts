...
import type { CompactionPreparation, CompactionResult } from "@oh-my-applepie/pi-agent-core/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@oh-my-applepie/pi-ai";

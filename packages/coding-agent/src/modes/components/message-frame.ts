...
import type { TextContent } from "@oh-my-applepie/pi-ai";
import type { Box, Component } from "@oh-my-applepie/pi-tui";
import { Markdown, Spacer, Text } from "@oh-my-applepie/pi-tui";

...
import { type Agent, type AgentMessage, type AgentToolResult, ThinkingLevel } from "@oh-my-applepie/pi-agent-core";
import type { CompactionOutcome } from "@oh-my-applepie/pi-agent-core/compaction";
import {
...
import type { Component, EditorTheme, SlashCommand } from "@oh-my-applepie/pi-tui";
import {
	Container,
	clearRenderCache,
	Loader,
...
export class InteractiveMode implements InteractiveModeContext {
	...
	showAgentProcessTable(): void {
		this.#selectorController.showAgentProcessTable();
	}
	showWorkspacesTable(): void {
		this.#selectorController.showWorkspacesTable();
	}

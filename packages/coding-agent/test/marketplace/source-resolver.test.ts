...
import type { MarketplacePluginEntry } from "@oh-my-applepie/pi-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@oh-my-applepie/pi-coding-agent/extensibility/plugins/marketplace";

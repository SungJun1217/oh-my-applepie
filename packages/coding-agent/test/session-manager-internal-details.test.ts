...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@oh-my-applepie/pi-coding-agent/session/messages";
import { type CustomMessageEntry, SessionManager } from "@oh-my-applepie/pi-coding-agent/session/session-manager";

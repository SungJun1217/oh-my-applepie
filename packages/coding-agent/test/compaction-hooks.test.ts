...
import {
	...
	type SessionEvent,
} from "@oh-my-applepie/pi-coding-agent/extensibility/hooks";
import { theme } from "@oh-my-applepie/pi-coding-agent/modes/theme/theme";
...
import { createTools, type ToolSession } from "@oh-my-applepie/pi-coding-agent/tools";

...
import { clearCache, readFile } from "@oh-my-applepie/pi-coding-agent/capability/fs";
...
import { getProjectPathCandidates } from "@oh-my-applepie/pi-coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/can1357/oh-my-applepie/issues/1116:

...
import { type MCPServer, mcpCapability } from "@oh-my-applepie/pi-coding-agent/capability/mcp";
import { loadCapability } from "@oh-my-applepie/pi-coding-agent/discovery";

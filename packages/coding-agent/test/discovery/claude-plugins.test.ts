...
import { loadCapability } from "@oh-my-applepie/pi-coding-agent/capability";
import { clearCache as clearFsCache } from "@oh-my-applepie/pi-coding-agent/capability/fs";
import {
	clearClaudePluginRootsCache,
	listClaudePluginRoots,
	parseClaudePluginsRegistry,
} from "@oh-my-applepie/pi-coding-agent/discovery/helpers";
import { discoverAgents } from "@oh-my-applepie/pi-coding-agent/task/discovery";
import "@oh-my-applepie/pi-coding-agent/discovery/claude-plugins";
import type { Skill } from "@oh-my-applepie/pi-coding-agent/capability/skill";
import type { SlashCommand } from "@oh-my-applepie/pi-coding-agent/capability/slash-command";

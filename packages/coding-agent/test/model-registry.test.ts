...
import { Effort, type Model, type OpenAICompat, type ThinkingConfig, writeModelCache } from "@oh-my-applepie/pi-ai";
import { kNoAuth, ModelRegistry } from "@oh-my-applepie/pi-coding-agent/config/model-registry";

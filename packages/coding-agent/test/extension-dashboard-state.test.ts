...
import { applyDisabledExtensionsToState } from "@oh-my-applepie/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@oh-my-applepie/pi-coding-agent/modes/components/extensions/types";

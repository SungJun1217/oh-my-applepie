...
import * as compactionModule from "@oh-my-applepie/pi-agent-core/compaction";
import type { AssistantMessage, ToolCall } from "@oh-my-applepie/pi-ai";
...
import { ExtensionRunner, loadExtensions } from "@oh-my-applepie/pi-coding-agent/extensibility/extensions";

...
} from "@oh-my-applepie/pi-coding-agent/session/session-manager";
...
async function createSessionHarness(
	...
	const [{ createAgentSession }, { Settings }, { AuthStorage }] = await Promise.all([
		import("@oh-my-applepie/pi-coding-agent/sdk"),
		import("@oh-my-applepie/pi-coding-agent/config/settings"),
		import("@oh-my-applepie/pi-coding-agent/session/auth-storage"),
	]);

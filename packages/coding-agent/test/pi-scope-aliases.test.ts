 ...
 * `@mariozechner` (original), `@earendil-works` (fork), and `@oh-my-applepie`
 ...
 *   - `@oh-my-applepie/swarm-extension`         ⇒ `@oh-my-applepie/pi-utils`
 *   - `@plannotator/pi-extension`         ⇒ `@oh-my-applepie/pi-agent-core`
 *   - `@runfusion/fusion`                 ⇒ `@oh-my-applepie/pi-coding-agent/...`
 *
...
import { loadExtensions } from "@oh-my-applepie/pi-coding-agent/extensibility/extensions/loader";
import { TempDir } from "@oh-my-applepie/pi-utils";

const canonicalCodingAgent = Bun.resolveSync("@oh-my-applepie/pi-coding-agent", import.meta.dir);
const canonicalCodingAgentExtensions = Bun.resolveSync(
	"@oh-my-applepie/pi-coding-agent/extensibility/extensions",
	import.meta.dir,
);
const canonicalUtils = Bun.resolveSync("@oh-my-applepie/pi-utils", import.meta.dir);
const canonicalTui = Bun.resolveSync("@oh-my-applepie/pi-tui", import.meta.dir);
...
const canonicalAiOauth = Bun.resolveSync("@oh-my-applepie/pi-ai/utils/oauth", import.meta.dir);
...
const CASES: readonly AliasCase[] = [
	...
	// @oh-my-applepie self-import — canonical scope must still flow through the shim
	// so a duplicate copy is never dragged in from a plugin's own node_modules.
	{ id: "ohmypi-utils", aliasSpecifier: "@oh-my-applepie/pi-utils", canonicalPath: canonicalUtils, symbol: "logger" },
	{
		id: "ohmypi-coding-agent",
		aliasSpecifier: "@oh-my-applepie/pi-coding-agent",

...
import type { completeSimple, Model } from "@oh-my-applepie/pi-ai";
...
import { InspectImageTool } from "@oh-my-applepie/pi-coding-agent/tools/inspect-image";
import { inspectImageToolRenderer } from "@oh-my-applepie/pi-coding-agent/tools/inspect-image-renderer";
import { toolRenderers } from "@oh-my-applepie/pi-coding-agent/tools/renderers";

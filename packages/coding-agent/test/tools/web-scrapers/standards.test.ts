...
import { handleCheatSh } from "@oh-my-applepie/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@oh-my-applepie/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@oh-my-applepie/pi-coding-agent/web/scrapers/tldr";

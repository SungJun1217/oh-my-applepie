...
import { handleBiorxiv } from "@oh-my-applepie/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@oh-my-applepie/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@oh-my-applepie/pi-coding-agent/web/scrapers/wikidata";

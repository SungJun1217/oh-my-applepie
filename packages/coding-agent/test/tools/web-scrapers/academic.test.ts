...
import { handleArxiv } from "@oh-my-applepie/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@oh-my-applepie/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@oh-my-applepie/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@oh-my-applepie/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@oh-my-applepie/pi-coding-agent/web/scrapers/types";

...
import { handleHuggingFace } from "@oh-my-applepie/pi-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@oh-my-applepie/pi-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@oh-my-applepie/pi-coding-agent/web/scrapers/vimeo";

...
import { handleAur } from "@oh-my-applepie/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@oh-my-applepie/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@oh-my-applepie/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@oh-my-applepie/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@oh-my-applepie/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@oh-my-applepie/pi-coding-agent/web/scrapers/rubygems";

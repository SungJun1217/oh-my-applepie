...
import { handleMDN } from "@oh-my-applepie/pi-coding-agent/web/scrapers/mdn";
import { handleReadTheDocs } from "@oh-my-applepie/pi-coding-agent/web/scrapers/readthedocs";

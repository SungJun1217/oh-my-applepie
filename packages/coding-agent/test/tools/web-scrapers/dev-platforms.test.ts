...
import { handleDevTo } from "@oh-my-applepie/pi-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@oh-my-applepie/pi-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@oh-my-applepie/pi-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@oh-my-applepie/pi-coding-agent/web/scrapers/lobsters";

...
import { handleArtifactHub } from "@oh-my-applepie/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@oh-my-applepie/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@oh-my-applepie/pi-coding-agent/web/scrapers/discogs";

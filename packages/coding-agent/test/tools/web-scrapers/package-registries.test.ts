...
import { handleCratesIo } from "@oh-my-applepie/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@oh-my-applepie/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@oh-my-applepie/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@oh-my-applepie/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@oh-my-applepie/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@oh-my-applepie/pi-coding-agent/web/scrapers/pypi";

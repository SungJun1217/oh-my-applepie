...
import { handleChocolatey } from "@oh-my-applepie/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@oh-my-applepie/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@oh-my-applepie/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@oh-my-applepie/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@oh-my-applepie/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@oh-my-applepie/pi-coding-agent/web/scrapers/terraform";

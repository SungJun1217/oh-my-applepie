...
import { InternalUrlRouter, LocalProtocolHandler } from "@oh-my-applepie/pi-coding-agent/internal-urls";
...
import { SearchTool } from "@oh-my-applepie/pi-coding-agent/tools/search";

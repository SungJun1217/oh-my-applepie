...
import { type Skill as CapabilitySkill, skillCapability } from "@oh-my-applepie/pi-coding-agent/capability/skill";
import { getCapability } from "@oh-my-applepie/pi-coding-agent/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "@oh-my-applepie/pi-coding-agent/extensibility/skills";

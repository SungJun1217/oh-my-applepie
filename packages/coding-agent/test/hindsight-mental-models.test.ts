...
import type { BankScope } from "@oh-my-applepie/pi-coding-agent/hindsight/bank";
import {
	type HindsightApi,
	HindsightApi as HindsightApiCtor,
	type MentalModelSummary,
} from "@oh-my-applepie/pi-coding-agent/hindsight/client";
import {
...
} from "@oh-my-applepie/pi-coding-agent/hindsight/mental-models";

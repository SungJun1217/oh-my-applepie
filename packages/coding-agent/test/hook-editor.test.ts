...
import { HookEditorComponent } from "@oh-my-applepie/pi-coding-agent/modes/components/hook-editor";
import { ExtensionUiController } from "@oh-my-applepie/pi-coding-agent/modes/controllers/extension-ui-controller";

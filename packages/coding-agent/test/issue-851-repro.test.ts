...
import { clearClaudePluginRootsCache } from "@oh-my-applepie/pi-coding-agent/discovery/helpers";
import "@oh-my-applepie/pi-coding-agent/discovery/claude-plugins";
import type { MCPServer } from "@oh-my-applepie/pi-coding-agent/capability/mcp";

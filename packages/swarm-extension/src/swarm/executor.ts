/**
 * Swarm agent execution via oh-my-applepie's subagent infrastructure.
 *
...
import { runSubprocess } from "@oh-my-applepie/pi-coding-agent";
...
/**
 * Execute a single swarm agent as an oh-my-applepie subagent.
 *
 * The agent receives:

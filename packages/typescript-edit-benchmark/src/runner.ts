...
import type { AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@oh-my-applepie/pi-agent-core";
import type { Model } from "@oh-my-applepie/pi-ai";
import { computeLineHash, formatSessionDumpText, RpcClient } from "@oh-my-applepie/pi-coding-agent";
...
const CLI_PATH = Bun.fileURLToPath(import.meta.resolve("@oh-my-applepie/pi-coding-agent/cli"));
...
interface BenchmarkClient {
	start(): Promise<void>;
	setThinkingLevel(level: import("@oh-my-applepie/pi-agent-core").ResolvedThinkingLevel): Promise<void>;

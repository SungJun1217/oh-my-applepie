 ...
 */
import type { AgentEvent, AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@oh-my-applepie/pi-agent-core";
import type { Model } from "@oh-my-applepie/pi-ai";
import type { AgentSession, AgentSessionEvent, AuthStorage, SessionStats } from "@oh-my-applepie/pi-coding-agent";
import {
...
export async function discoverSharedInfra(options: DiscoverSharedInfraOptions = {}): Promise<SharedInfra> {
	const { ModelRegistry: MR } = await import("@oh-my-applepie/pi-coding-agent");

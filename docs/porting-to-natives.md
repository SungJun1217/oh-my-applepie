...
`@oh-my-applepie/pi-natives` no longer has a `packages/natives/src/<module>` TypeScript wrapper layer. The package root points at generated native artifacts:
...
Consumers import directly from `@oh-my-applepie/pi-natives`. The generated declarations are produced during `bun --cwd=packages/natives run build`.
...
- `packages/natives/package.json` exposes only the package root (`@oh-my-applepie/pi-natives`).
...
- Import the new export directly from `@oh-my-applepie/pi-natives`.

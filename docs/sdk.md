...
The SDK is the in-process integration surface for `@oh-my-applepie/pi-coding-agent`.
...
```bash
bun add @oh-my-applepie/pi-coding-agent
```

## Entry points

`@oh-my-applepie/pi-coding-agent` exports the SDK APIs from the package root (and also via `@oh-my-applepie/pi-coding-agent/sdk`).
...
```ts
import { createAgentSession } from "@oh-my-applepie/pi-coding-agent";
...
```ts
import { createAgentSession, SessionManager } from "@oh-my-applepie/pi-coding-agent";
...
```ts
import { SessionManager } from "@oh-my-applepie/pi-coding-agent";
...
import {
  ...
  ModelRegistry,
  SessionManager,
} from "@oh-my-applepie/pi-coding-agent";
